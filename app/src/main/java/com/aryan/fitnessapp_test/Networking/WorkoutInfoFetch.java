        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    JSONArray jsonArray = jsonObject.getJSONArray(context.getString(R.string.results_json));
    ...
    public  static void fetchWorkoutImage(String url, final onFetchImageCompleted l1, final Context context){
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    JSONObject jsonObject = new JSONObject(response);
                    JSONObject large = jsonObject.getJSONObject(context.getString(R.string.large_cropped_txt));
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(context, R.string.image_not_avail,Toast.LENGTH_SHORT).show();
            }
        });
        MySingleton.getInstance(context).addToRequestQueue(stringRequest);
