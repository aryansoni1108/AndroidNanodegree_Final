...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new HomeFragment(), getString(R.string.home_frag_toolbar));
        adapter.addFragment(new BrowseFragment(), getString(R.string.workout_frag_text));
        adapter.addFragment(new FavoritesFragment(), getString(R.string.fav_frag_text));
