...
public class WorkoutDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        StopButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(isCounterRunning){
                    countDownTimer.cancel();
                    time=600000;
                    button.setText(R.string.start_btx_txt);
        ...
        final String imageURL = getString(R.string.image_url_p1)+id+getString(R.string.image_url_2);
    ...
    public void reverseTimer(long miliSeconds,final Button tv){
        ...
        countDownTimer=new CountDownTimer(miliSeconds, 1000) {
            ...
            public void onFinish() {
                tv.setText(getString(R.string.complete_btx_txt));
...
//for preserving rotation state of timer
    @Override
