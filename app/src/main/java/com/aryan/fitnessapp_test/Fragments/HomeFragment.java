...
public class HomeFragment extends Fragment {
    ...
    @BindView(R.id.chart)
    GraphView chart;
    @BindView(R.id.Graph_error)TextView graphError;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bmi_btx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bmi_txt_view.setText(String.valueOf(bmi));
        ...
        if(ref!=null) {
            readData(ref, new onGetDataListener() {
                ...
                public void onSuccess(DataSnapshot dataSnapshot) {
                    Log.e(TAG, getString(R.string.finish_fire_log));

                }

                @Override
                public void onStart() {
                    Log.e(TAG, getString(R.string.start_fire_log));
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot ds :dataSnapshot.getChildren()) {
                    ...
                    if (ds.getChildrenCount() < 2) {
                        graphError.setVisibility(View.VISIBLE);
                        graphError.setText(R.string.morethantwo);
                ...
                series.setTitle(getString(R.string.bmi_history));
                ...
                chart.getGridLabelRenderer().setNumHorizontalLabels(4);
